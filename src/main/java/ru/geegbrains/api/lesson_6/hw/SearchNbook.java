...
public class SearchNbook {

    private Set<NBook> notebooks = new HashSet<>();
    private List<Criterion> criterionList = new ArrayList<>();
    private static Scanner scanner = new Scanner(System.in);

    public void printList(){
        for (NBook notebook : notebooks){
    ...
    public boolean notebookIsCorrect(NBook notebook){
    ...
    public SearchNbook(Set<NBook> notebooks) {
        this.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
    }

    public SearchNbook(Set<NBook> notebooks, List<Criterion> criterionList) {
        this.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
